...
class Test_2c(GradedTestCase):
  @graded(timeout=7)
  def test_0(self):
    """2c-0-basic:  Basic test for add_unit_constraints"""
  ...
  @graded(timeout=3, is_hidden=True)
  def test_1(self):
    """2c-1-hidden:  Test add_unit_constraints with different profiles"""
  ...
  def test_2(self):
    """2c-2-hidden:  Test unsatisfiable scheduling"""
  ...
  def test_3(self):
    """2c-3-hidden:  Test MVC+AC-3+all additional constraints"""
